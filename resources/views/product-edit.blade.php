...
@section('title', 'Edit Produk - LuxVerum')
...
<img src="{{ asset('image/LX-luxverum.png') }}" alt="Logo LuxVerum" style="width:150px; height:auto;">
    ...
    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group full-width">
            ...
            @if($product->gambar)
                <img src="{{ asset('storage/' . $product->gambar) }}" alt="{{ $product->nama }}" style="max-width: 200px; margin-top: 10px; border-radius: 8px;">
            @endif
        </div>
        ...
        <a href="{{ route('product.list') }}" style="display: inline-block; background: #fff ;border: 2px solid #b30000; color: #b30000; padding: 10px 18px; border-radius: 8px;font-weight: bold; text-decoration: none; text-align: center; margin-top: 15px; transition: all 0.3s; width: 300px;">Kembali ke Daftar Produk</a>
    </form>
@endsection
